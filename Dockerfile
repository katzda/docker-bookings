...
RUN a2dissite 000-default.conf; \
    ...
    sed -i -E  "s/ServerAdmin webmaster@localhost/ServerAdmin %email_address%/; \
                s/#ServerName www.example.com/ServerName %WEB_DOMAIN_NAME%%URL_ENDING%/; \
                s/DocumentRoot \/var\/www\/html/DocumentRoot \/var\/www\/%WEB_DOMAIN_NAME%%URL_ENDING%\/%PATH_TO_PUBLIC_ESCAPED%\/public\//" \
                /etc/apache2/sites-available/%WEB_DOMAIN_NAME%%URL_ENDING%.conf; \
    a2enmod rewrite; \
